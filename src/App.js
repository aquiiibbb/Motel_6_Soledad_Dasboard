...
function DashboardContent({ onLogout }) {
  ...
  const fetchFeedback = async () => {
    try {
      ...
      const response = await axios.get("https://motel-6-soledad-backend.onrender.com/feedback");
  ...
  const deleteFeedback = async (id) => {
    if (window.confirm("Are you sure you want to delete this feedback?")) {
      try {
        await axios.delete(`https://motel-6-soledad-backend.onrender.com/feedback/${id}`);
